        ...
        <ul class="options">
            <li><a class="option" @click="activeComponent('infoUser')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-person-circle svg" viewBox="0 0 16 16">
            ...
            <li><a class="option">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-bag svg" viewBox="0 0 16 16">
                        <path
            ...
            <li><a class="option">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-shop svg" viewBox="0 0 16 16">
                        <path
            ...
            <li><a class="option">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-shop-window svg" viewBox="0 0 16 16">
                        <path
            ...
            <li><a @click="Logout" class="logout option">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-box-arrow-right svg" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
